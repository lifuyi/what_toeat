...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"今天吃什么","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
exports.convertRecipeToDish = convertRecipeToDish;
exports.default = void 0;
...
exports.searchRecipesByIngredients = searchRecipesByIngredients;
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 5));
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ 18));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
...
var CURRENT_PLATFORM = (0, _config.getPlatform)();
...
function request(url) {
  ...
  return new Promise(function (resolve, reject) {
    // 检查网络协议支持
    var isHttps = BASE_URL.startsWith('https://');
    var isHttp = BASE_URL.startsWith('http://');
    ...
    var config = {
      ...
      success: function success(res) {
        ...
        if (res.statusCode === 200) {
          ...
          var errorMsg = getPlatformErrorMessage(res.statusCode, res.data);
...
function getPlatformErrorMessage(statusCode, data) {
  var baseMsg = "HTTP ".concat(statusCode, ": ").concat((data === null || data === void 0 ? void 0 : data.message) || 'Request failed');
  switch (CURRENT_PLATFORM) {
    case 'mp-weixin':
      if (statusCode === 600) {
...
function getPlatformNetworkError(err) {
  var _err$errMsg, _err$errMsg2, _err$message, _err$errMsg3;
  switch (CURRENT_PLATFORM) {
    case 'mp-weixin':
      if ((_err$errMsg = err.errMsg) !== null && _err$errMsg !== void 0 && _err$errMsg.includes('timeout')) {
        return '微信小程序请求超时，请检查网络连接';
      }
      if ((_err$errMsg2 = err.errMsg) !== null && _err$errMsg2 !== void 0 && _err$errMsg2.includes('fail')) {
    ...
    case 'mp-alipay':
      ...
      break;
    case 'h5':
      if ((_err$message = err.message) !== null && _err$message !== void 0 && _err$message.includes('CORS')) {
        return 'H5跨域请求被阻止，请检查服务器CORS配置';
      }
      break;
    case 'app-plus':
      if ((_err$errMsg3 = err.errMsg) !== null && _err$errMsg3 !== void 0 && _err$errMsg3.includes('timeout')) {
        return 'App网络请求超时，请检查网络连接';
      }
      break;
  }
  return "\u7F51\u7EDC\u8BF7\u6C42\u5931\u8D25 (".concat(CURRENT_PLATFORM, ")\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5\u548C\u670D\u52A1\u5668\u72B6\u6001");
}

// 获取推荐菜品
function getRecommendedRecipes(preferences) {
...
function getRecipeById(id) {
  return request("/api/recipes/".concat(id));
}
...
// 转换后端数据格式为前端格式
function convertRecipeToDish(recipe) {
  // 处理食材列表
  var ingredients = recipe.yl ? recipe.yl.split(/[,，、\n]/).filter(function (item) {
    return item.trim();
  }) : [];

  // 处理制作步骤
  var steps = recipe.steptext ? recipe.steptext.split(/\d+[\.、]/).filter(function (step) {
    return step.trim();
  }) : [];
...
function calculateMatchScore(dish, preferences) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(weights); _i < _Object$entries.length; _i++) {
    ...
    if (dish.scores[key] !== undefined && preferences[key] !== undefined) {
      ...
      var similarity = 1 - Math.abs(dish.scores[key] - preferences[key]) / 9;
...
var _default = {
  ...
  searchRecipesByIngredients: searchRecipesByIngredients,
  getRecipeById: getRecipeById,
  getAllRecipes: getAllRecipes,
  convertRecipeToDish: convertRecipeToDish,
...
// 检查当前平台是否支持某个功能
function checkPlatformSupport(feature) {
  var _supportMatrix$featur;
  ...
  return ((_supportMatrix$featur = supportMatrix[feature]) === null || _supportMatrix$featur === void 0 ? void 0 : _supportMatrix$featur.includes(platform)) || false;
}
var _default = CONFIG;
exports.default = _default;
...
var navigation = {
  ...
  navigateTo: function navigateTo(url) {
    ...
    var platform = (0, _config.getPlatform)();
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.getNetworkType();
            case 2:
              networkType = _context.sent;
              return _context.abrupt("return", networkType !== 'none' && networkType !== 'unknown');
            case 4:
            case "end":
      ...
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this2.getSystemInfo();
            case 2:
              systemInfo = _context2.sent;
              platform = (0, _config.getPlatform)();
...
var features = {
  ...
  supports: function supports(feature) {
    return (0, _config.checkPlatformSupport)(feature);
  },
  // 获取支持的功能列表
  getSupportedFeatures: function getSupportedFeatures() {
    var _this3 = this;
    var features = ['http', 'https', 'localStorage', 'location', 'share', 'payment', 'camera'];
    return features.filter(function (feature) {
      return _this3.supports(feature);
    });
  },
  // 获取平台限制信息
  getPlatformLimitations: function getPlatformLimitations() {
    var platform = (0, _config.getPlatform)();
    var limitations = {
      'mp-weixin': ['只支持HTTPS请求', '需要配置服务器域名白名单', '包体积限制2MB', '单个页面栈限制10层'],
      'mp-alipay': ['只支持HTTPS请求', '需要配置服务器域名白名单', '包体积限制2MB'],
      'h5': ['受CORS策略限制', '不支持某些原生API', '性能受浏览器影响'],
      'app-plus': ['需要原生插件支持某些功能', '打包体积较大']
    };
...
var _default = {
  ...
  device: device,
  features: features,
  getPlatform: _config.getPlatform
};
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))
